...
<input type="hidden" name="proj_id" value="<?php if (isset($_GET['proj_id'])) {
    echo esc_html_e($_GET['proj_id']);
    } elseif ($p_id) {
        echo esc_html_e($p_id);
    } ?>">
        ...
        <?php if (isset($_GET['post'])) { ?>
            <div class="pto-project-user-section-header-title">
                <ul class="pto-project-user-section-title">
                    <li><span class="pto-project-user-section_titles_detail"><?php esc_html_e('Username', PTO_NB_MYPLTEXT); ?></span></li>
                ...
                if (isset($_GET['post'])) {
                    ...
                    if (is_array($post_meta)) {
                        foreach ($post_meta as $user_id) {
                            ...
                            ?>
                            <li id='select-<?php echo intval($user->data->ID); ?>'>
